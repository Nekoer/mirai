 ...
 * @see MessagePreSendEvent
 */
public data class GuildChannelMessagePreSendEvent @MiraiInternalApi constructor(
    /** 发信目标. */
 ...
 * @see MessagePreSendEvent
 */
public data class GuildDirectMessagePreSendEvent @MiraiInternalApi constructor(
    /** 发信目标. */
